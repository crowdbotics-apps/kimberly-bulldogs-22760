"""kimberly_bulldogs_22760 URL Configuration
...
admin.site.site_header = "Kimberly Bulldogs"
admin.site.site_title = "Kimberly Bulldogs Admin Portal"
admin.site.index_title = "Kimberly Bulldogs Admin"

# swagger
api_info = openapi.Info(
    title="Kimberly Bulldogs API",
    default_version="v1",
    description="API documentation for Kimberly Bulldogs App",
)
